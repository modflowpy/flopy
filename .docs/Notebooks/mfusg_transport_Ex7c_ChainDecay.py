...
bct = MfUsgBct(mf, itrnsp=3, mcomp=4, itvd = 0, cinact=-999.9, diffnc= diffnc, 
               prsity = 0.33, bulkd = 1.6, anglex=anglex, dl=0.0, dt=0.0,
               iadsorb=1, adsorb=adsorb, ifod=3, fodrw=fodrw, fodrs=0,
               timeweight=1.0, chaindecay=True,
               nparent=[0,1,1,1],jparent=[0,1,2,3],stotio=[0,0.795,0.737,0.640])
...
mdt = MfUsgMdt(mf, mdflag=2, frahk=True, volfracmd=0.4, pormd=0.4, rhobmd=1.6, difflenmd=0.5, 
               tortmd=0.7, kdmd= 0.19375, decaymd=0.4, yieldmd=0.0,diffmd= 0.031558)


# In[16]:


lrcsc = {(0,0): ["DELTAT 0.5", "TMAXAT 0.5", "TMINAT 0.5", "TADJAT 1.0", "TCUTAT 2.0", "SAVE HEAD", "SAVE BUDGET", "SAVE CONC"]}
