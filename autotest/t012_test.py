...
def test_mf2005_p07():
    ...
    mf = flopy.modflow.Modflow.load(
        namfile, model_ws=pth, verbose=True, exe_name=mf2005_exe
    )
...
def test_mf2000_p07():
    ...
    namfile = "p7mf2k.nam"
    mf = flopy.modflow.Modflow.load(
        namfile, model_ws=pth, verbose=True, exe_name=mf2k_exe
    )
...
def test_mf2000_HSSTest():
    ...
    mf = flopy.modflow.Modflow.load(
        namfile, model_ws=pth, version="mf2k", verbose=True, exe_name=mf2k_exe
    )
...
def test_mf2000_tob():
    ...
    namfile = "p7mt.nam"
    mt = flopy.mt3d.mt.Mt3dms.load(
        namfile, model_ws=pth, verbose=True, exe_name=mt3d_exe, forgive=True
    )
    mt.model_ws = cpth
    ftlfile = "p7.ftl"
    mt.ftlfilename = ftlfile
