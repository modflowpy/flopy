...
def singleModel(iChild,
    ...
    dis = flopy.modflow.ModflowDis(mf,
        ...
        nper=nper, perlen=perlen, tsmult=1.07, nstp=nstp,
    ...
    lpf = flopy.modflow.ModflowLpf(mf,
        hk=hkPerLayer, vka=vkaPerLayer, ss=ssPerLayer,
        ipakcb=53+iLUoffset,
...
def test_simple_lgrmodel_from_scratch():
...
if __name__ == '__main__':
    ...
    test_simple_lgrmodel_from_scratch()
