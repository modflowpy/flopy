...
def test_grid_array(function_tmpdir):
    ...
    aux = {1: [[50.0], [1.3]], 3: [[200.0], [1.5]]}
    #aux2 = {1: [[50.0], [1.3]], 2: [[60.0], [11.3]], 3: [[200.0], [1.5]]}
    irch = {1: [[0, 2], [2, 1]], 2: [[0, 1], [2, 3]]}
    rcha = ModflowGwfrcha(
        model,
        print_input=True,
    ...
    print(f"SHAPE: {np.shape(rcha.aux.array)}")
    #rcha.aux.set_data(aux2)
    print(rcha.aux.array)
    print(rcha.aux.get_data())
    print(f"RENO RCHA AUX ARRAY:")
    #assert False
    val_irch = rcha.irch.array.sum(axis=(1, 2, 3))
    assert val_irch[0] == 4
    assert val_irch[1] == 5
...
#    assert wel_array[3][0][1] == 0.1
    ...
    for n in range(4):
        ...
        if n == 1:
            ...
            welaux2[0, 0, 0] = 9.0
        #welqspd[n + 1] = q
        #welconcspd[n + 1] = [welconc, welaux2]
        welqspd[n] = q
