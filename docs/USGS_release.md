...
header-includes:
    ...
    - \fancyfoot[LE, RO]{FloPy version 3.2.9 &mdash; mp7-refactor}
    - \fancyfoot[CO, CE]{\thepage\ of \pageref{LastPage}}
    - \fancyfoot[RE, LO]{10/12/2018}
...
Installation
-----------------------------------------------
To install FloPy version 3.2.9 &mdash; mp7-refactor from the USGS FloPy website:
```
pip install https://water.usgs.gov/ogw/flopy/flopy-3.2.9.zip
```

To update to FloPy version 3.2.9 &mdash; mp7-refactor from the USGS FloPy website:
```
