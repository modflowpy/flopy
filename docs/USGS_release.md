...
header-includes:
    ...
    - \fancyfoot[LE, RO]{FloPy version 3.2.11}
...
[Bakker, M., Post, V., Langevin, C.D., Hughes, J.D., White, J.T., Starn, J.J., and Fienen, M.N., 2019, FloPy v3.2.11: U.S. Geological Survey Software Release, 22 March 2019, http://dx.doi.org/10.5066/F7BK19FH](http://dx.doi.org/10.5066/F7BK19FH)
...
Installation
-----------------------------------------------
To install FloPy version 3.2.11 from the USGS FloPy website:
```
pip install https://water.usgs.gov/ogw/flopy/flopy-3.2.11.zip
```

To update to FloPy version 3.2.11 from the USGS FloPy website:
```
pip install https://water.usgs.gov/ogw/flopy/flopy-3.2.11.zip --upgrade
```
