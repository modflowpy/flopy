...
header-includes:
    ...
    - \fancyfoot[LE, RO]{FloPy version 3.2.9 &mdash; mp7part-refactor}
    - \fancyfoot[CO, CE]{\thepage\ of \pageref{LastPage}}
    - \fancyfoot[RE, LO]{10/13/2018}
...
Installation
-----------------------------------------------
To install FloPy version 3.2.9 &mdash; mp7part-refactor from the USGS FloPy website:
```
pip install https://water.usgs.gov/ogw/flopy/flopy-3.2.9.zip
```

To update to FloPy version 3.2.9 &mdash; mp7part-refactor from the USGS FloPy website:
```
