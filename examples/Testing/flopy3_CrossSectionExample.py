...
hv = modelxsect.csplot_array(head, head=head, masked_values=[999.00, -1.00000E+30]) #, norm=norm)
...
# The return value for this function is a matplotlib LineCollection object,
# which could be manipulated (or used) later if necessary.
hv = modelxsect.csplot_array(head, masked_values=[999.00, -1.00000E+30], norm=norm)
ct = modelxsect.cscontour_array(head, masked_values=[999.00, -1.00000E+30],
                                colors='black', linewidths=0.5,
                                levels=[10, 15, 20, 25, 30])
plt.clabel(ct, fontsize=8, fmt='%3.1f')
patches = modelxsect.csplot_ibound()
linecollection = modelxsect.csplot_grid()
