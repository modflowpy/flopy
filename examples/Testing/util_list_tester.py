...
riv2 = flopy.pakbase.Package.load(
    model, flopy.modflow.ModflowRiv, "modflowtest.riv"
)
ghb = flopy.pakbase.Package.load(
    model, flopy.modflow.ModflowGhb, "modflowtest.ghb"
)
riv1.write_file()
