...
class ModflowChfcdb(mfpackage.MFPackage):
    ...
    """
    auxiliary = ListTemplateGenerator(('chf6', 'cdb', 'options',
                                       'auxiliary'))
    obs_filerecord = ListTemplateGenerator(('chf6', 'cdb', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('chf6', 'cdb', 'period',
                                                'stress_period_data'))
    package_abbr = "chfcdb"
    _package_type = "cdb"
