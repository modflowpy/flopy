...
class ModflowChfchd(mfpackage.MFPackage):
    ...
    """
    auxiliary = ListTemplateGenerator(('chf6', 'chd', 'options',
                                       'auxiliary'))
    ts_filerecord = ListTemplateGenerator(('chf6', 'chd', 'options',
                                           'ts_filerecord'))
    obs_filerecord = ListTemplateGenerator(('chf6', 'chd', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('chf6', 'chd', 'period',
                                                'stress_period_data'))
    package_abbr = "chfchd"
    _package_type = "chd"
