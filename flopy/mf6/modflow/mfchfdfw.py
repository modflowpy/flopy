...
class ModflowChfdfw(mfpackage.MFPackage):
    """
    ModflowChfdfw defines a dfw package within a chf6 model.
    ...
    obs_filerecord = ListTemplateGenerator(("chf6", "dfw", "options", "obs_filerecord"))
    manningsn = ArrayTemplateGenerator(("chf6", "dfw", "griddata", "manningsn"))
    idcxs = ArrayTemplateGenerator(("chf6", "dfw", "griddata", "idcxs"))
    package_abbr = "chfdfw"
    _package_type = "dfw"
    dfn_file_name = "chf-dfw.dfn"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "dfw", filename, pname, loading_package, **kwargs)

        # set up variables
        self.central_in_space = self.build_mfdata("central_in_space", central_in_space)
        ...
        self.dev_swr_conductance = self.build_mfdata(
