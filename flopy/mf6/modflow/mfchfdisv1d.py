...
class ModflowChfdisv1D(mfpackage.MFPackage):
    ...
    width = ArrayTemplateGenerator(("chf6", "disv1d", "griddata", "width"))
    bottom = ArrayTemplateGenerator(("chf6", "disv1d", "griddata", "bottom"))
    idomain = ArrayTemplateGenerator(("chf6", "disv1d", "griddata", "idomain"))
    vertices = ListTemplateGenerator(("chf6", "disv1d", "vertices", "vertices"))
    cell1d = ListTemplateGenerator(("chf6", "disv1d", "cell1d", "cell1d"))
