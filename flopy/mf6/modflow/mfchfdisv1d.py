...
class ModflowChfdisv1D(mfpackage.MFPackage):
    """
    ModflowChfdisv1D defines a disv1d package within a chf6 model.
    ...
    cell1d : [icell1d, fdc, ncvert, icvert]
        * icell1d (integer) is the cell1d number. Records in the cell1d block
    ...
    """
    width = ArrayTemplateGenerator(('chf6', 'disv1d', 'griddata',
                                    'width'))
    bottom = ArrayTemplateGenerator(('chf6', 'disv1d', 'griddata',
                                     'bottom'))
    idomain = ArrayTemplateGenerator(('chf6', 'disv1d', 'griddata',
                                      'idomain'))
    vertices = ListTemplateGenerator(('chf6', 'disv1d', 'vertices',
                                      'vertices'))
    cell1d = ListTemplateGenerator(('chf6', 'disv1d', 'cell1d',
                                    'cell1d'))
    package_abbr = "chfdisv1d"
    _package_type = "disv1d"
    dfn_file_name = "chf-disv1d.dfn"
    ...
    dfn = [
           ...
           ["block vertices", "name yv", "type double precision",
            "in_record true", "tagged false", "reader urword",
            "optional false"],
           ["block cell1d", "name cell1d",
            "type recarray icell1d fdc ncvert icvert", "shape (nodes)",
            "reader urword", "optional false"],
           ["block cell1d", "name icell1d", "type integer",
            "in_record true", "tagged false", "reader urword",
            "optional false", "numeric_index true"],
           ["block cell1d", "name fdc", "type double precision",
            "in_record true", "tagged false", "reader urword",
            "optional false"],
           ["block cell1d", "name ncvert", "type integer", "in_record true",
            "tagged false", "reader urword", "optional false"],
           ["block cell1d", "name icvert", "type integer", "shape (ncvert)",
            "in_record true", "tagged false", "reader urword",
            "optional false", "numeric_index true"]]

    def __init__(self, model, loading_package=False, length_units=None,
                 nogrb=None, xorigin=None, yorigin=None, angrot=None,
                 export_array_ascii=None, nodes=None, nvert=None, width=None,
                 bottom=None, idomain=None, vertices=None, cell1d=None,
        ...
        self.cell1d = self.build_mfdata("cell1d", cell1d)
