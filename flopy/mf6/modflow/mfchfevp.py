...
class ModflowChfevp(mfpackage.MFPackage):
    """
    ModflowChfevp defines a evp package within a chf6 model.
    ...
    auxiliary = ListTemplateGenerator(("chf6", "evp", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("chf6", "evp", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("chf6", "evp", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("chf6", "evp", "period", "stress_period_data")
    )
    package_abbr = "chfevp"
    _package_type = "evp"
    dfn_file_name = "chf-evp.dfn"
