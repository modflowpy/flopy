...
class ModflowChfflw(mfpackage.MFPackage):
    """
    ModflowChfflw defines a flw package within a chf6 model.
    ...
    auxiliary = ListTemplateGenerator(("chf6", "flw", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("chf6", "flw", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("chf6", "flw", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("chf6", "flw", "period", "stress_period_data")
    )
    package_abbr = "chfflw"
    _package_type = "flw"
    dfn_file_name = "chf-flw.dfn"
