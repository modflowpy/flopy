...
class ModflowChfgwf(mfpackage.MFPackage):
    """
    ModflowChfgwf defines a chfgwf package.
    ...
    obs_filerecord = ListTemplateGenerator(("chfgwf", "options", "obs_filerecord"))
    exchangedata = ListTemplateGenerator(("chfgwf", "exchangedata", "exchangedata"))
    package_abbr = "chfgwf"
    _package_type = "chfgwf"
    dfn_file_name = "exg-chfgwf.dfn"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            simulation, "chfgwf", filename, pname, loading_package, **kwargs
        )
        ...
        self.fixed_conductance = self.build_mfdata(
