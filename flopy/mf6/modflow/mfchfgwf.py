...
class ModflowChfgwf(mfpackage.MFPackage):
    ...
    """
    obs_filerecord = ListTemplateGenerator(('chfgwf', 'options',
                                            'obs_filerecord'))
    exchangedata = ListTemplateGenerator(('chfgwf', 'exchangedata',
                                          'exchangedata'))
    package_abbr = "chfgwf"
    ...
    def __init__(self, simulation, loading_package=False, exgtype="CHF6-GWF6",
                 ...
                 **kwargs):
        super().__init__(simulation, "chfgwf", filename, pname,
