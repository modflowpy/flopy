...
class ModflowChfoc(mfpackage.MFPackage):
    ...
    """
    budget_filerecord = ListTemplateGenerator(('chf6', 'oc', 'options',
                                               'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('chf6', 'oc',
                                                  'options',
                                                  'budgetcsv_filerecord'))
    qoutflow_filerecord = ListTemplateGenerator(('chf6', 'oc', 'options',
                                                 'qoutflow_filerecord'))
    stage_filerecord = ListTemplateGenerator(('chf6', 'oc', 'options',
                                              'stage_filerecord'))
    qoutflowprintrecord = ListTemplateGenerator(('chf6', 'oc', 'options',
                                                 'qoutflowprintrecord'))
    saverecord = ListTemplateGenerator(('chf6', 'oc', 'period',
                                        'saverecord'))
    printrecord = ListTemplateGenerator(('chf6', 'oc', 'period',
                                         'printrecord'))
    package_abbr = "chfoc"
    _package_type = "oc"
