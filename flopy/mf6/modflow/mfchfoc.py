...
class ModflowChfoc(mfpackage.MFPackage):
    """
    ModflowChfoc defines a oc package within a chf6 model.
    ...
    budgetcsv_filerecord = ListTemplateGenerator(
        ("chf6", "oc", "options", "budgetcsv_filerecord")
    )
    qoutflow_filerecord = ListTemplateGenerator(
        ("chf6", "oc", "options", "qoutflow_filerecord")
    )
    stage_filerecord = ListTemplateGenerator(
        ("chf6", "oc", "options", "stage_filerecord")
    )
    qoutflowprintrecord = ListTemplateGenerator(
        ("chf6", "oc", "options", "qoutflowprintrecord")
    )
    saverecord = ListTemplateGenerator(("chf6", "oc", "period", "saverecord"))
    printrecord = ListTemplateGenerator(("chf6", "oc", "period", "printrecord"))
    package_abbr = "chfoc"
    _package_type = "oc"
    dfn_file_name = "chf-oc.dfn"
    ...
    def __init__(
        ...
        qoutflow_filerecord=None,
        stage_filerecord=None,
        qoutflowprintrecord=None,
        saverecord=None,
        printrecord=None,
        filename=None,
        pname=None,
        **kwargs,
        ...
        self.qoutflow_filerecord = self.build_mfdata(
            "qoutflow_filerecord", qoutflow_filerecord
        )
        self.stage_filerecord = self.build_mfdata("stage_filerecord", stage_filerecord)
        self.qoutflowprintrecord = self.build_mfdata(
            "qoutflowprintrecord", qoutflowprintrecord
        )
