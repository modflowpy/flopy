...
class ModflowChfpcp(mfpackage.MFPackage):
    """
    ModflowChfpcp defines a pcp package within a chf6 model.
    ...
    auxmultname : string
        * auxmultname (string) name of auxiliary variable to be used as
          multiplier of precipitation.
    boundnames : boolean
        * boundnames (boolean) keyword to indicate that boundary names may be
          provided with the list of precipitation cells.
    print_input : boolean
        * print_input (boolean) keyword to indicate that the list of
          precipitation information will be written to the listing file
          immediately after it is read.
    print_flows : boolean
        * print_flows (boolean) keyword to indicate that the list of
          precipitation flow rates will be printed to the listing file for
    ...
    save_flows : boolean
        * save_flows (boolean) keyword to indicate that precipitation flow
    ...
    maxbound : integer
        * maxbound (integer) integer value specifying the maximum number of
          precipitation cells cells that will be specified for use during any
          stress period.
    stress_period_data : [cellid, precipitation, aux, boundname]
        ...
        * precipitation (double) is the precipitation flux rate
          (:math:`LT^{-1}`). This rate is multiplied inside the program by the
          surface area of the cell to calculate the volumetric precipitation
          rate. If the Options block includes a TIMESERIESFILE entry (see the
        ...
        * aux (double) represents the values of the auxiliary variables for
          each precipitation. The values of auxiliary variables must be present
          for each precipitation. The values must be specified in the order of
        ...
        * boundname (string) name of the precipitation cell. BOUNDNAME is an
    ...
    auxiliary = ListTemplateGenerator(("chf6", "pcp", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("chf6", "pcp", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("chf6", "pcp", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("chf6", "pcp", "period", "stress_period_data")
    )
    package_abbr = "chfpcp"
    _package_type = "pcp"
    dfn_file_name = "chf-pcp.dfn"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "pcp", filename, pname, loading_package, **kwargs)
