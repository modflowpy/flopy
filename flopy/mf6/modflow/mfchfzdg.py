...
class ModflowChfzdg(mfpackage.MFPackage):
    ...
    """
    auxiliary = ListTemplateGenerator(('chf6', 'zdg', 'options',
                                       'auxiliary'))
    ts_filerecord = ListTemplateGenerator(('chf6', 'zdg', 'options',
                                           'ts_filerecord'))
    obs_filerecord = ListTemplateGenerator(('chf6', 'zdg', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('chf6', 'zdg', 'period',
                                                'stress_period_data'))
    package_abbr = "chfzdg"
    _package_type = "zdg"
