...
class ModflowGweesl(MFPackage):
    """
    ModflowGweesl defines a ESL package.
    ...
    boundnames : keyword
        keyword to indicate that boundary names may be provided with the list of energy
        source loading cells.
    print_input : keyword
        keyword to indicate that the list of energy source loading information will be
        written to the listing file immediately after it is read.
    print_flows : keyword
        keyword to indicate that the list of energy source loading flow rates will be
    ...
    save_flows : keyword
        keyword to indicate that energy source loading flow terms will be written to
    ...
    observations : record obs6 filein obs6_filename
        ...
        more information.
    maxbound : integer
        integer value specifying the maximum number of source cells that will be
    ...
    stress_period_data : [(cellid, senerrate, aux, boundname)]
        ...
        * senerrate : double precision
                is the energy source loading rate. A positive value indicates addition of
                energy and a negative value indicates removal of energy. If the Options block
        ...
        * aux : [double precision]
                represents the values of the auxiliary variables for each energy source. The
                values of auxiliary variables must be present for each energy source. The
                ...
                a numeric value.
        * boundname : string
                name of the energy source cell.  BOUNDNAME is an ASCII character variable that
    ...
    **kwargs
    ...
    auxiliary = ArrayTemplateGenerator(("gwe6", "esl", "options", "auxiliary"))
    ...
    spec = {
        ...
        "dimensions": {
            "maxbound": {
                "block": "dimensions",
                "description": "integer value specifying the maximum number of source cells that will be specified for use during any stress period.",
        ...
        "options": {
            ...
            "auxmultname": {
                "block": "options",
                "description": "name of auxiliary variable to be used as multiplier of energy loading rate.",
            ...
            "boundnames": {
                "block": "options",
                "description": "keyword to indicate that boundary names may be provided with the list of energy source loading cells.",
                "name": "boundnames",
                "optional": True,
                "reader": "urword",
                "type": "keyword",
            ...
            "print_flows": {
                "block": "options",
                "description": "keyword to indicate that the list of energy source loading flow rates will be printed to the listing file for every stress period time step in which 'budget print' is specified in output control.  if there is no output control option and 'print_flows' is specified, then flow rates are printed for the last time step of each stress period.",
            ...
            "print_input": {
                "block": "options",
                "description": "keyword to indicate that the list of energy source loading information will be written to the listing file immediately after it is read.",
