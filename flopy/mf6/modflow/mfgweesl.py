...
class ModflowGweesl(mfpackage.MFPackage):
    ...
    ts_filerecord = ListTemplateGenerator(("gwe6", "esl", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("gwe6", "esl", "options", "obs_filerecord"))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "esl", filename, pname, loading_package, **kwargs)
