...
class ModflowGwelke(MFPackage):
    ...
    **kwargs
    ...
    auxiliary = ArrayTemplateGenerator(('gwe6', 'lke', 'options', 'auxiliary'))
    temperature_filerecord = ListTemplateGenerator(('gwe6', 'lke', 'options', 'temperature_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwe6', 'lke', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwe6', 'lke', 'options', 'budgetcsv_filerecord'))
