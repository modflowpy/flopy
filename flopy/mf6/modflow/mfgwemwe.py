...
class ModflowGwemwe(MFPackage):
    ...
    packagedata : [(mawno, strt, ktf, fthk, aux, boundname)]
        * mawno : integer
                ...
                data on the line. MAWNO must be greater than zero and less than or equal to
                NMAWWELLS.
        * strt : double precision
                real value that defines the starting temperature for the well.
        * ktf : double precision
                is the thermal conductivity of the material between the aquifer cell and the
                feature. The thickness of the material is defined by the variable FTHK.
        * fthk : double precision
                real value that defines the thickness of the material through which conduction
    ...
    mweperioddata : [(mawno, mwesetting)]
        * mawno : integer
                ...
                data on the line. mawno must be greater than zero and less than or equal to
                nmawwells.
        * mwesetting : temperature | status | rate | auxiliaryrecord
                line of information that is parsed into a keyword and values.  keyword values
                that can be used to start the mwesetting string include: status, temperature,
                ...
                temperatures cannot be specified for all flow terms.  for example, the multi-
                aquifer well package supports a 'withdrawal' flow term.  if this withdrawal
                term is active, then water will be withdrawn from the well at the calculated
                temperature of the well.
                * temperature : string
                            real or character value that defines the temperature for the well. the
                            specified temperature is only applied if the well is a constant temperature
                ...
                * status : string
                            ...
                            the well temperature.  if a well is constant, then the temperature for the well
                            will be fixed at the user specified value.
                * rate : string
                            real or character value that defines the injection temperature
                            :math:`(e.g.,:^{circ}c:or:^{circ}f)` for the well. if the options block
    ...
    **kwargs
    ...
    temperature_filerecord = ListTemplateGenerator(('gwe6', 'mwe', 'options', 'temperature_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwe6', 'mwe', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwe6', 'mwe', 'options', 'budgetcsv_filerecord'))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.print_temperature = self.build_mfdata('print_temperature', print_temperature)
