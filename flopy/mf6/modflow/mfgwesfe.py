...
class ModflowGwesfe(MFPackage):
    ...
    **kwargs
    ...
    temperature_filerecord = ListTemplateGenerator(('gwe6', 'sfe', 'options', 'temperature_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwe6', 'sfe', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwe6', 'sfe', 'options', 'budgetcsv_filerecord'))
    ...
    reachperioddata = ListTemplateGenerator(('gwe6', 'sfe', 'period', 'reachperioddata'))
    package_abbr = 'gwesfe'
    _package_type = 'sfe'
