...
class ModflowGweuze(MFPackage):
    ...
    **kwargs
    ...
    temperature_filerecord = ListTemplateGenerator(('gwe6', 'uze', 'options', 'temperature_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwe6', 'uze', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwe6', 'uze', 'options', 'budgetcsv_filerecord'))
