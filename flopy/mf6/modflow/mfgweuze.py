...
class ModflowGweuze(mfpackage.MFPackage):
          ...
          specified for all flow terms.
            ...
            infiltration : [string]
                * infiltration (string) real or character value that defines
                  the temperature of the infiltration
                  :math:`(e.g.,\\:^{\\circ}C\\:or\\:^{\\circ}F)` for the UZF
                  cell. If the Options block includes a TIMESERIESFILE entry
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "uze", filename, pname, loading_package, **kwargs)
