...
class ModflowGwfdisv(MFPackage):
    """
    ...
    idomain : [integer]
        ...
        simulation.  furthermore, the first existing cell above will be connected to
        the first existing cell below.  this type of cell is referred to as a 'vertical
        pass through' cell.
    vertices : [(iv, xv, yv)]
        * iv : integer
    ...
    **kwargs
    ...
    grb_filerecord = ListTemplateGenerator(('gwf6', 'disv', 'options', 'grb_filerecord'))
    ncf_filerecord = ListTemplateGenerator(('gwf6', 'disv', 'options', 'ncf_filerecord'))
