...
class ModflowGwfdrn(MFPackage):
    ...
    stress_period_data : [(cellid, elev, cond, aux, boundname)]
        ...
        * elev : double precision
                is the elevation of the drain. If the Options block includes a TIMESERIESFILE
        ...
        * cond : double precision
                ...
                drain. If the Options block includes a TIMESERIESFILE entry (see the 'Time-
        ...
        * aux : [double precision]
                represents the values of the auxiliary variables for each drain. The values of
                auxiliary variables must be present for each drain. The values must be
                ...
                numeric value.
        * boundname : string
                name of the drain cell.  BOUNDNAME is an ASCII character variable that can
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dev_cubic_scaling = self.build_mfdata('dev_cubic_scaling', dev_cubic_scaling)
