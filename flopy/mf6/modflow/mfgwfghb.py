...
class ModflowGwfghb(MFPackage):
    """
    ModflowGwfghb defines a GHB package.
    ...
    auxmultname : string
        name of auxiliary variable to be used as multiplier of general-head boundary
        conductance.
    boundnames : keyword
        keyword to indicate that boundary names may be provided with the list of
        general-head boundary cells.
    print_input : keyword
        keyword to indicate that the list of general-head boundary information will be
        written to the listing file immediately after it is read.
    print_flows : keyword
        keyword to indicate that the list of general-head boundary flow rates will be
    ...
    save_flows : keyword
        keyword to indicate that general-head boundary flow terms will be written to
    ...
    observations : record obs6 filein obs6_filename
        ...
        more information.
    mover : keyword
        keyword to indicate that this instance of the general-head boundary package can
        be used with the water mover (mvr) package.  when the mover option is
        specified, additional memory is allocated within the package to store the
        available, provided, and received water.
    maxbound : integer
        integer value specifying the maximum number of general-head boundary cells that
    ...
    stress_period_data : [(cellid, bhead, cond, aux, boundname)]
        ...
        * bhead : double precision
                is the boundary head. If the Options block includes a TIMESERIESFILE entry (see
        ...
        * cond : double precision
                is the hydraulic conductance of the interface between the aquifer cell and the
                boundary. If the Options block includes a TIMESERIESFILE entry (see the 'Time-
        ...
        * aux : [double precision]
                represents the values of the auxiliary variables for each general-head
                boundary. The values of auxiliary variables must be present for each general-
                head boundary. The values must be specified in the order of the auxiliary
        ...
        * boundname : string
                name of the general-head boundary cell.  BOUNDNAME is an ASCII character
    ...
    **kwargs
    ...
    auxiliary = ArrayTemplateGenerator(('gwf6', 'ghb', 'options', 'auxiliary'))
