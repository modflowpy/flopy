...
class ModflowGwfghb(mfpackage.MFPackage):
    ...
    ts_filerecord = ListTemplateGenerator(("gwf6", "ghb", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("gwf6", "ghb", "options", "obs_filerecord"))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "ghb", filename, pname, loading_package, **kwargs)
