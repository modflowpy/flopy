    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._gnc_package = self.build_child_package('gnc', gncdata, 'gncdata', self._gnc_filerecord)
        self._mvr_filerecord = self.build_mfdata('mvr_filerecord', None)
        self._mvr_package = self.build_child_package('mvr', perioddata, 'perioddata', self._mvr_filerecord)
