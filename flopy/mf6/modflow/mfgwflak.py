...
class ModflowGwflak(MFPackage):
    ...
    **kwargs
    ...
    stage_filerecord = ListTemplateGenerator(('gwf6', 'lak', 'options', 'stage_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwf6', 'lak', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwf6', 'lak', 'options', 'budgetcsv_filerecord'))
    package_convergence_filerecord = ListTemplateGenerator(('gwf6', 'lak', 'options', 'package_convergence_filerecord'))
    ...
    connectiondata = ListTemplateGenerator(('gwf6', 'lak', 'connectiondata', 'connectiondata'))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.maximum_stage_change = self.build_mfdata('maximum_stage_change', maximum_stage_change)
