...
class ModflowGwfoc(MFPackage):
    ...
    **kwargs
    ...
    budget_filerecord = ListTemplateGenerator(('gwf6', 'oc', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwf6', 'oc', 'options', 'budgetcsv_filerecord'))
    head_filerecord = ListTemplateGenerator(('gwf6', 'oc', 'options', 'head_filerecord'))
    headprintrecord = ListTemplateGenerator(('gwf6', 'oc', 'options', 'headprintrecord'))
