...
class ModflowGwfrch(mfpackage.MFPackage):
    ...
    ts_filerecord = ListTemplateGenerator(("gwf6", "rch", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("gwf6", "rch", "options", "obs_filerecord"))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "rch", filename, pname, loading_package, **kwargs)
