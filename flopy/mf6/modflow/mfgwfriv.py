...
class ModflowGwfriv(MFPackage):
    """
    ModflowGwfriv defines a RIV package.
    ...
    boundnames : keyword
        keyword to indicate that boundary names may be provided with the list of river
        cells.
    print_input : keyword
        keyword to indicate that the list of river information will be written to the
        listing file immediately after it is read.
    print_flows : keyword
        keyword to indicate that the list of river flow rates will be printed to the
    ...
    save_flows : keyword
        keyword to indicate that river flow terms will be written to the file specified
    ...
    observations : record obs6 filein obs6_filename
        ...
        more information.
    mover : keyword
        keyword to indicate that this instance of the river package can be used with
        ...
        received water.
    maxbound : integer
        integer value specifying the maximum number of rivers cells that will be
    ...
    stress_period_data : [(cellid, stage, cond, rbot, aux, boundname)]
        ...
        * stage : double precision
                is the head in the river. If the Options block includes a TIMESERIESFILE entry
        ...
        * cond : double precision
                is the riverbed hydraulic conductance. If the Options block includes a
                ...
                numeric value.
        * rbot : double precision
                is the elevation of the bottom of the riverbed.  If the Options block includes
                a TIMESERIESFILE entry (see the 'Time-Variable Input' section), values can be
                obtained from a time series by entering the time-series name in place of a
                numeric value.
        * aux : [double precision]
                represents the values of the auxiliary variables for each river. The values of
                auxiliary variables must be present for each river. The values must be
                ...
                numeric value.
        * boundname : string
                name of the river cell.  BOUNDNAME is an ASCII character variable that can
    ...
    **kwargs
    ...
    auxiliary = ArrayTemplateGenerator(("gwf6", "riv", "options", "auxiliary"))
    ...
    spec = {
        ...
        "options": {
            ...
            "boundnames": {
                "block": "options",
                "description": "keyword to indicate that boundary names may be provided with the list of river cells.",
                "name": "boundnames",
                "optional": True,
                "reader": "urword",
                "type": "keyword",
            ...
            "mover": {
                "block": "options",
                "description": "keyword to indicate that this instance of the river package can be used with the water mover (mvr) package.  when the mover option is specified, additional memory is allocated within the package to store the available, provided, and received water.",
                "name": "mover",
                "optional": True,
                "reader": "urword",
                "type": "keyword",
            ...
            "print_flows": {
                "block": "options",
                "description": "keyword to indicate that the list of river flow rates will be printed to the listing file for every stress period time step in which 'budget print' is specified in output control.  if there is no output control option and 'print_flows' is specified, then flow rates are printed for the last time step of each stress period.",
            ...
            "print_input": {
                "block": "options",
                "description": "keyword to indicate that the list of river information will be written to the listing file immediately after it is read.",
            ...
            "save_flows": {
                "block": "options",
                "description": "keyword to indicate that river flow terms will be written to the file specified with 'budget fileout' in output control.",
            ...
            "stress_period_data": {
                ...
                "item": {
                    ...
                    "fields": {
                        ...
                        "boundname": {
                            "block": "period",
                            "description": "name of the river cell.  BOUNDNAME is an ASCII character variable that can contain as many as 40 characters.  If BOUNDNAME contains spaces in it, then the entire name must be enclosed within single quotes.",
                            "longname": "drain name",
                            "name": "boundname",
                            "optional": "true",
                            "reader": "urword",
