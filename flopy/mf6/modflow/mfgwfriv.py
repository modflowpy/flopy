...
class ModflowGwfriv(mfpackage.MFPackage):
    ...
    ts_filerecord = ListTemplateGenerator(("gwf6", "riv", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("gwf6", "riv", "options", "obs_filerecord"))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "riv", filename, pname, loading_package, **kwargs)
