...
class ModflowGwfrivg(MFPackage):
    ...
    readarraygrid : keyword
        indicates that array-based grid input will be used for the river package.  this
        keyword must be specified to use array-based grid input.  when readarraygrid is
        specified, values must be provided for every cell within a model grid, even
        ...
        results. no data cells should contain the value dnodata (3.0e+30).
    auxiliary : [string]
