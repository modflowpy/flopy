...
class ModflowGwfsfr(MFPackage):
    ...
    **kwargs
    ...
    stage_filerecord = ListTemplateGenerator(('gwf6', 'sfr', 'options', 'stage_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwf6', 'sfr', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwf6', 'sfr', 'options', 'budgetcsv_filerecord'))
    package_convergence_filerecord = ListTemplateGenerator(('gwf6', 'sfr', 'options', 'package_convergence_filerecord'))
    ...
    crosssections = ListTemplateGenerator(('gwf6', 'sfr', 'crosssections', 'crosssections'))
    connectiondata = ListTemplateGenerator(('gwf6', 'sfr', 'connectiondata', 'connectiondata'))
    diversions = ListTemplateGenerator(('gwf6', 'sfr', 'diversions', 'diversions'))
    initialstages = ListTemplateGenerator(('gwf6', 'sfr', 'initialstages', 'initialstages'))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.maximum_picard_iterations = self.build_mfdata('maximum_picard_iterations', maximum_picard_iterations)
        ...
        self.dev_storage_weight = self.build_mfdata('dev_storage_weight', dev_storage_weight)
