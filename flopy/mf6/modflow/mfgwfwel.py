...
class ModflowGwfwel(MFPackage):
    ...
    **kwargs
    ...
    afrcsv_filerecord = ListTemplateGenerator(('gwf6', 'wel', 'options', 'afrcsv_filerecord'))
    ...
    stress_period_data = ListTemplateGenerator(('gwf6', 'wel', 'period', 'stress_period_data'))
    package_abbr = 'gwfwel'
    _package_type = 'wel'
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.afrcsv_filerecord = self.build_mfdata('afrcsv_filerecord', afrcsv_filerecord)
        self.flow_reduction_length = self.build_mfdata('flow_reduction_length', flow_reduction_length)
