...
class ModflowGwtist(mfpackage.MFPackage):
    ...
    def __init__(self, model, loading_package=False, save_flows=None,
                 sorbtion=None, first_order_decay=None, zero_order_decay=None,
                 cim_filerecord=None, cimprintrecord=None, cim=None,
                 thetaim=None, zetaim=None, decay=None, decay_sorbed=None,
                 bulk_density=None, distcoef=None, filename=None, pname=None,
                 parent_file=None):
        super(ModflowGwtist, self).__init__(model, "ist", filename, pname,
