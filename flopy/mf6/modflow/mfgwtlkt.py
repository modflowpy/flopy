...
class ModflowGwtlkt(mfpackage.MFPackage):
    ...
    ts_filerecord = ListTemplateGenerator(("gwt6", "lkt", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("gwt6", "lkt", "options", "obs_filerecord"))
    packagedata = ListTemplateGenerator(("gwt6", "lkt", "packagedata", "packagedata"))
    lakeperioddata = ListTemplateGenerator(("gwt6", "lkt", "period", "lakeperioddata"))
    package_abbr = "gwtlkt"
    _package_type = "lkt"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "lkt", filename, pname, loading_package, **kwargs)
