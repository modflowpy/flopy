...
class ModflowGwtmvt(MFPackage):
    ...
    **kwargs
    ...
    budget_filerecord = ListTemplateGenerator(('gwt6', 'mvt', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwt6', 'mvt', 'options', 'budgetcsv_filerecord'))
    package_abbr = 'gwtmvt'
    _package_type = 'mvt'
