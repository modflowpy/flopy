...
class ModflowGwtnam(MFPackage):
    ...
    **kwargs
    ...
    nc_mesh2d_filerecord = ListTemplateGenerator(('gwt6', 'nam', 'options', 'nc_mesh2d_filerecord'))
    nc_structured_filerecord = ListTemplateGenerator(('gwt6', 'nam', 'options', 'nc_structured_filerecord'))
