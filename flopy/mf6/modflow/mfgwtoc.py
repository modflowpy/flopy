...
class ModflowGwtoc(MFPackage):
    """
    ModflowGwtoc defines a OC package.
    ...
    concentration_filerecord : (concentrationfile)
        * concentrationfile : string
                name of the output file to write conc information.

    concentrationprintrecord : (concentration, print_format)
    ...
    saverecord : (save, rtype, ocsetting)
        ...
        * rtype : string
                type of information to save or print.  Can be BUDGET or CONCENTRATION.
    ...
    **kwargs
    ...
    budget_filerecord = ListTemplateGenerator(('gwt6', 'oc', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwt6', 'oc', 'options', 'budgetcsv_filerecord'))
    concentration_filerecord = ListTemplateGenerator(('gwt6', 'oc', 'options', 'concentration_filerecord'))
    concentrationprintrecord = ListTemplateGenerator(('gwt6', 'oc', 'options', 'concentrationprintrecord'))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.concentrationprintrecord = self.build_mfdata('concentrationprintrecord', concentrationprintrecord)
