...
class ModflowGwtsft(MFPackage):
    ...
    **kwargs
    ...
    concentration_filerecord = ListTemplateGenerator(('gwt6', 'sft', 'options', 'concentration_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwt6', 'sft', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwt6', 'sft', 'options', 'budgetcsv_filerecord'))
    ...
    reachperioddata = ListTemplateGenerator(('gwt6', 'sft', 'period', 'reachperioddata'))
    package_abbr = 'gwtsft'
    _package_type = 'sft'
