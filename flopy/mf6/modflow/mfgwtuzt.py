...
class ModflowGwtuzt(mfpackage.MFPackage):
    ...
    ts_filerecord = ListTemplateGenerator(("gwt6", "uzt", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("gwt6", "uzt", "options", "obs_filerecord"))
    packagedata = ListTemplateGenerator(("gwt6", "uzt", "packagedata", "packagedata"))
    uztperioddata = ListTemplateGenerator(("gwt6", "uzt", "period", "uztperioddata"))
    package_abbr = "gwtuzt"
    _package_type = "uzt"
