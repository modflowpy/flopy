...
class ModflowGwtuzt(MFPackage):
    ...
    **kwargs
    ...
    auxiliary = ArrayTemplateGenerator(('gwt6', 'uzt', 'options', 'auxiliary'))
    concentration_filerecord = ListTemplateGenerator(('gwt6', 'uzt', 'options', 'concentration_filerecord'))
    budget_filerecord = ListTemplateGenerator(('gwt6', 'uzt', 'options', 'budget_filerecord'))
    budgetcsv_filerecord = ListTemplateGenerator(('gwt6', 'uzt', 'options', 'budgetcsv_filerecord'))
