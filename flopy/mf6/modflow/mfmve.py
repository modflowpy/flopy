...
class ModflowMve(MFPackage):
    """
    ModflowMve defines a MVE package.
    ...
    **kwargs
    ...
    budget_filerecord = ListTemplateGenerator(("mve", "options", "budget_filerecord"))
    budgetcsv_filerecord = ListTemplateGenerator(
        ("mve", "options", "budgetcsv_filerecord")
    )
    package_abbr = "mve"
    _package_type = "mve"
...
class MvePackages(MFChildPackages):
    """
    MvePackages is a container class for the ModflowMve class.
    """

    package_abbr = "mvepackages"
    ...
    def initialize(
        ...
        """
        Initialize a new ModflowMve package, removing any sibling
        child packages attached to the same parent package.

        See :class:`ModflowMve` for parameter definitions.
        """
        new_package = ModflowMve(
            self._cpparent,
    ...
    def append_package(
        ...
        """
        Add a new ModflowMve package to the container.
