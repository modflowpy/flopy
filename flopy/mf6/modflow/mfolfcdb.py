...
class ModflowOlfcdb(mfpackage.MFPackage):
    ...
    """
    auxiliary = ListTemplateGenerator(('olf6', 'cdb', 'options',
                                       'auxiliary'))
    obs_filerecord = ListTemplateGenerator(('olf6', 'cdb', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('olf6', 'cdb', 'period',
                                                'stress_period_data'))
    package_abbr = "olfcdb"
    _package_type = "cdb"
