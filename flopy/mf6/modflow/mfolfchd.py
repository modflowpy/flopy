...
class ModflowOlfchd(mfpackage.MFPackage):
    ...
    """
    auxiliary = ListTemplateGenerator(('olf6', 'chd', 'options',
                                       'auxiliary'))
    ts_filerecord = ListTemplateGenerator(('olf6', 'chd', 'options',
                                           'ts_filerecord'))
    obs_filerecord = ListTemplateGenerator(('olf6', 'chd', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('olf6', 'chd', 'period',
                                                'stress_period_data'))
    package_abbr = "olfchd"
    _package_type = "chd"
