...
class ModflowOlfdis2D(mfpackage.MFPackage):
    """
    ModflowOlfdis2D defines a dis2d package within a olf6 model.
    ...
    delr = ArrayTemplateGenerator(("olf6", "dis2d", "griddata", "delr"))
    delc = ArrayTemplateGenerator(("olf6", "dis2d", "griddata", "delc"))
    bottom = ArrayTemplateGenerator(("olf6", "dis2d", "griddata", "bottom"))
    idomain = ArrayTemplateGenerator(("olf6", "dis2d", "griddata", "idomain"))
    package_abbr = "olfdis2d"
    _package_type = "dis2d"
    dfn_file_name = "olf-dis2d.dfn"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "dis2d", filename, pname, loading_package, **kwargs)
