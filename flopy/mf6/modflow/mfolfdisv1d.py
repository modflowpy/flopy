...
class ModflowOlfdisv1D(mfpackage.MFPackage):
    ...
    """
    length = ArrayTemplateGenerator(('olf6', 'disv1d', 'griddata',
                                     'length'))
    width = ArrayTemplateGenerator(('olf6', 'disv1d', 'griddata',
                                    'width'))
    bottom = ArrayTemplateGenerator(('olf6', 'disv1d', 'griddata',
                                     'bottom'))
    idomain = ArrayTemplateGenerator(('olf6', 'disv1d', 'griddata',
                                      'idomain'))
    vertices = ListTemplateGenerator(('olf6', 'disv1d', 'vertices',
                                      'vertices'))
    cell2d = ListTemplateGenerator(('olf6', 'disv1d', 'cell2d',
                                    'cell2d'))
