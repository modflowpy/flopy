...
class ModflowOlfdisv2D(mfpackage.MFPackage):
    """
    ModflowOlfdisv2D defines a disv2d package within a olf6 model.
    ...
    bottom = ArrayTemplateGenerator(("olf6", "disv2d", "griddata", "bottom"))
    idomain = ArrayTemplateGenerator(("olf6", "disv2d", "griddata", "idomain"))
    vertices = ListTemplateGenerator(("olf6", "disv2d", "vertices", "vertices"))
    cell2d = ListTemplateGenerator(("olf6", "disv2d", "cell2d", "cell2d"))
    package_abbr = "olfdisv2d"
    _package_type = "disv2d"
    dfn_file_name = "olf-disv2d.dfn"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "disv2d", filename, pname, loading_package, **kwargs)
