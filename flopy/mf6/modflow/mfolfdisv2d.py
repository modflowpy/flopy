...
class ModflowOlfdisv2D(mfpackage.MFPackage):
    ...
    """
    bottom = ArrayTemplateGenerator(('olf6', 'disv2d', 'griddata',
                                     'bottom'))
    idomain = ArrayTemplateGenerator(('olf6', 'disv2d', 'griddata',
                                      'idomain'))
    vertices = ListTemplateGenerator(('olf6', 'disv2d', 'vertices',
                                      'vertices'))
    cell2d = ListTemplateGenerator(('olf6', 'disv2d', 'cell2d',
                                    'cell2d'))
