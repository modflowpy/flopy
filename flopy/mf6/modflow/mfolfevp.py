...
class ModflowOlfevp(mfpackage.MFPackage):
    """
    ModflowOlfevp defines a evp package within a olf6 model.
    ...
    auxmultname : string
        * auxmultname (string) name of auxiliary variable to be used as
          multiplier of evaporation.
    boundnames : boolean
        * boundnames (boolean) keyword to indicate that boundary names may be
          provided with the list of evaporation cells.
    print_input : boolean
        * print_input (boolean) keyword to indicate that the list of
          evaporation information will be written to the listing file
          immediately after it is read.
    print_flows : boolean
        * print_flows (boolean) keyword to indicate that the list of
          evaporation flow rates will be printed to the listing file for every
    ...
    save_flows : boolean
        * save_flows (boolean) keyword to indicate that evaporation flow terms
    ...
    maxbound : integer
        * maxbound (integer) integer value specifying the maximum number of
          evaporation cells cells that will be specified for use during any
          stress period.
    stress_period_data : [cellid, evaporation, aux, boundname]
        ...
        * evaporation (double) is the evaporation flux rate (:math:`LT^{-1}`).
          This rate is multiplied inside the program by the water surface area
          of the cell to calculate the volumetric evaporation rate. If the
        ...
        * aux (double) represents the values of the auxiliary variables for
          each evaporation. The values of auxiliary variables must be present
          for each evaporation. The values must be specified in the order of
        ...
        * boundname (string) name of the evaporation cell. BOUNDNAME is an
    ...
    auxiliary = ListTemplateGenerator(("olf6", "evp", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("olf6", "evp", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("olf6", "evp", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("olf6", "evp", "period", "stress_period_data")
    )
    package_abbr = "olfevp"
    _package_type = "evp"
    dfn_file_name = "olf-evp.dfn"
    ...
    dfn = [
        ...
        [
            ...
            "type recarray cellid evaporation aux boundname",
            "shape (maxbound)",
            "reader urword",
            "mf6internal spd",
        ],
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "evp", filename, pname, loading_package, **kwargs)
