...
class ModflowOlfflw(mfpackage.MFPackage):
    """
    ModflowOlfflw defines a flw package within a olf6 model.
    ...
    stress_period_data : [cellid, q, aux, boundname]
        ...
        * q (double) is the volumetric inflow rate. A positive value indicates
          inflow to the stream. Negative values are not allowed. If the Options
    ...
    auxiliary = ListTemplateGenerator(("olf6", "flw", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("olf6", "flw", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("olf6", "flw", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("olf6", "flw", "period", "stress_period_data")
    )
    package_abbr = "olfflw"
    _package_type = "flw"
    dfn_file_name = "olf-flw.dfn"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, "flw", filename, pname, loading_package, **kwargs)
