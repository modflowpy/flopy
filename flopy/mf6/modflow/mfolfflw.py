...
class ModflowOlfflw(mfpackage.MFPackage):
    ...
    """
    auxiliary = ListTemplateGenerator(('olf6', 'flw', 'options',
                                       'auxiliary'))
    ts_filerecord = ListTemplateGenerator(('olf6', 'flw', 'options',
                                           'ts_filerecord'))
    obs_filerecord = ListTemplateGenerator(('olf6', 'flw', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('olf6', 'flw', 'period',
                                                'stress_period_data'))
    package_abbr = "olfflw"
    _package_type = "flw"
