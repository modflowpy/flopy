...
class ModflowOlfgwf(mfpackage.MFPackage):
    ...
    obs_filerecord = ListTemplateGenerator(("olfgwf", "options", "obs_filerecord"))
    exchangedata = ListTemplateGenerator(("olfgwf", "exchangedata", "exchangedata"))
    package_abbr = "olfgwf"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            simulation, "olfgwf", filename, pname, loading_package, **kwargs
        )
