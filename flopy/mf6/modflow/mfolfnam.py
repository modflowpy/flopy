...
class ModflowOlfnam(mfpackage.MFPackage):
    """
    ModflowOlfnam defines a nam package within a olf6 model.
    ...
    list : string
        * list (string) is name of the listing file to create for this OLF
          model. If not specified, then the name of the list file will be the
          basename of the OLF model name file and the '.lst' extension. For
          example, if the OLF name file is called "my.model.nam" then the list
    ...
    packages : [ftype, fname, pname]
        * ftype (string) is the file type, which must be one of the following
          character values shown in table ref{table:ftype-olf}. Ftype may be
        ...
        * pname (string) is the user-defined name for the package. PNAME is
          ...
          OLF Model. If PNAME is specified for a stress package, then PNAME
    ...
    packages = ListTemplateGenerator(("olf6", "nam", "packages", "packages"))
    package_abbr = "olfnam"
    _package_type = "nam"
    dfn_file_name = "olf-nam.dfn"
