...
class ModflowOlfoc(mfpackage.MFPackage):
    ...
    budgetcsv_filerecord = ListTemplateGenerator(
        ("olf6", "oc", "options", "budgetcsv_filerecord")
    )
    qoutflow_filerecord = ListTemplateGenerator(
        ("olf6", "oc", "options", "qoutflow_filerecord")
    )
    stage_filerecord = ListTemplateGenerator(
        ("olf6", "oc", "options", "stage_filerecord")
    )
    qoutflowprintrecord = ListTemplateGenerator(
        ("olf6", "oc", "options", "qoutflowprintrecord")
    )
    saverecord = ListTemplateGenerator(("olf6", "oc", "period", "saverecord"))
    printrecord = ListTemplateGenerator(("olf6", "oc", "period", "printrecord"))
    package_abbr = "olfoc"
    _package_type = "oc"
