...
class ModflowOlfpcp(mfpackage.MFPackage):
    """
    ModflowOlfpcp defines a pcp package within a olf6 model.
    ...
    auxiliary = ListTemplateGenerator(("olf6", "pcp", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("olf6", "pcp", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("olf6", "pcp", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("olf6", "pcp", "period", "stress_period_data")
    )
    package_abbr = "olfpcp"
    _package_type = "pcp"
    dfn_file_name = "olf-pcp.dfn"
