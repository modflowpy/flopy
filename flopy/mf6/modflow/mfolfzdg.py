...
class ModflowOlfzdg(mfpackage.MFPackage):
    ...
    """
    auxiliary = ListTemplateGenerator(('olf6', 'zdg', 'options',
                                       'auxiliary'))
    ts_filerecord = ListTemplateGenerator(('olf6', 'zdg', 'options',
                                           'ts_filerecord'))
    obs_filerecord = ListTemplateGenerator(('olf6', 'zdg', 'options',
                                            'obs_filerecord'))
    stress_period_data = ListTemplateGenerator(('olf6', 'zdg', 'period',
                                                'stress_period_data'))
    package_abbr = "olfzdg"
    _package_type = "zdg"
