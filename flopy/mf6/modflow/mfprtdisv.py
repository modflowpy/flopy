...
class ModflowPrtdisv(MFPackage):
    ...
    **kwargs
    ...
    grb_filerecord = ListTemplateGenerator(('prt6', 'disv', 'options', 'grb_filerecord'))
    ncf_filerecord = ListTemplateGenerator(('prt6', 'disv', 'options', 'ncf_filerecord'))
