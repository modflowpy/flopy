...
class ModflowSwfcxs(mfpackage.MFPackage):
    ...
    packagedata = ListTemplateGenerator(
        ("swf6", "cxs", "packagedata", "packagedata")
    )
    crosssectiondata = ListTemplateGenerator(
        ("swf6", "cxs", "crosssectiondata", "crosssectiondata")
    )
    package_abbr = "swfcxs"
    _package_type = "cxs"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            model, "cxs", filename, pname, loading_package, **kwargs
        )
        ...
        self.crosssectiondata = self.build_mfdata(
