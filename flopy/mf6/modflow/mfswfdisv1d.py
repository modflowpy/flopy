...
class ModflowSwfdisv1D(mfpackage.MFPackage):
    ...
    width = ArrayTemplateGenerator(("swf6", "disv1d", "griddata", "width"))
    bottom = ArrayTemplateGenerator(("swf6", "disv1d", "griddata", "bottom"))
    idomain = ArrayTemplateGenerator(("swf6", "disv1d", "griddata", "idomain"))
    vertices = ListTemplateGenerator(("swf6", "disv1d", "vertices", "vertices"))
    cell1d = ListTemplateGenerator(("swf6", "disv1d", "cell1d", "cell1d"))
