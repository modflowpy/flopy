...
class ModflowSwfdisv2D(mfpackage.MFPackage):
    ...
    bottom = ArrayTemplateGenerator(("swf6", "disv2d", "griddata", "bottom"))
    idomain = ArrayTemplateGenerator(("swf6", "disv2d", "griddata", "idomain"))
    vertices = ListTemplateGenerator(("swf6", "disv2d", "vertices", "vertices"))
    cell2d = ListTemplateGenerator(("swf6", "disv2d", "cell2d", "cell2d"))
