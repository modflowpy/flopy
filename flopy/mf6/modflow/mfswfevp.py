...
class ModflowSwfevp(mfpackage.MFPackage):
    """
    ModflowSwfevp defines a evp package within a swf6 model.
    ...
    auxiliary = ListTemplateGenerator(("swf6", "evp", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("swf6", "evp", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("swf6", "evp", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("swf6", "evp", "period", "stress_period_data")
    )
    package_abbr = "swfevp"
    _package_type = "evp"
    dfn_file_name = "swf-evp.dfn"
