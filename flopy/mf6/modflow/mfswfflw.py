...
class ModflowSwfflw(mfpackage.MFPackage):
    ...
    auxiliary = ListTemplateGenerator(("swf6", "flw", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("swf6", "flw", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("swf6", "flw", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("swf6", "flw", "period", "stress_period_data")
    )
    package_abbr = "swfflw"
    _package_type = "flw"
