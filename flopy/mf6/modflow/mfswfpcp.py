...
class ModflowSwfpcp(mfpackage.MFPackage):
    """
    ModflowSwfpcp defines a pcp package within a swf6 model.
    ...
    auxiliary = ListTemplateGenerator(("swf6", "pcp", "options", "auxiliary"))
    ts_filerecord = ListTemplateGenerator(("swf6", "pcp", "options", "ts_filerecord"))
    obs_filerecord = ListTemplateGenerator(("swf6", "pcp", "options", "obs_filerecord"))
    stress_period_data = ListTemplateGenerator(
        ("swf6", "pcp", "period", "stress_period_data")
    )
    package_abbr = "swfpcp"
    _package_type = "pcp"
    dfn_file_name = "swf-pcp.dfn"
