...
class ModflowUtllak_Tab(mfpackage.MFPackage):
    """
    ModflowUtllak_Tab defines a lak-tab package within a utl model.
    ...
    """
    laktabrecarray = ListTemplateGenerator(('lak-tab', 'table', 
                                            'laktabrecarray'))
    package_abbr = "utllak_tab"
    package_type = "lak-tab"
    ...
    def __init__(self, model, add_to_package_list=True, nrow=None, ncol=None,
                 ...
                 parent_file=None):
        super(ModflowUtllak_Tab, self).__init__(model, "lak_tab", fname, pname,
