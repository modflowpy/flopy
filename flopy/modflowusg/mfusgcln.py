"""
mfusgcln module.  Contains the ModflowUsgCln class. Note that the user can 
...
class ModflowUsgCln(Package):
    ...
    def __init__(
        ...
        self.cln_circ = make_recarray(
            cln_circ, dtype=ModflowUsgCln.get_clncirc_dtype(self.BHE)
        )
        ...
        if self.nrectyp > 0:
            ...
            self.cln_rect = make_recarray(
                cln_rect, dtype=ModflowUsgCln.get_clnrect_dtype(self.BHE)
            )
