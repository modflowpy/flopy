...
class StartingLocations():
    ...
    def get_empty_starting_locations_data(npt=0,
        ...
        """
        dtype = StartingLocations.get_dtypes()
    ...
    def write_file(self, data=None, float_format='{:.8f}'):
        ...
        with open(self.fn_path, 'w') as output:
            ...
            for g in groups:
                ...
                output.write('{}\n{:d}\n'.format(g.decode(), npt))
            for p in self.data:
                output.write('{:d} {:d} {:d} {:d} {:d} {:d}'.format(p.particleid,
                                                                    p.particlegroup,
                                                                    p.initialgrid,
                                                                    p.k0, p.i0, p.j0))
                fmtstr = ' {0} {0} {0} {0} '.format(float_format)
                output.write(fmtstr.format(p.xloc0, p.yloc0, p.zloc0, p.initialtime))
