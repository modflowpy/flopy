...
class ZoneBudget(object):
    ...
    def _get_internal_flow_terms_tuple_frf(self, bud, izone, ich):
    ...
    def _get_internal_flow_terms_tuple_fff(self, bud, izone, ich):
    ...
    def _get_internal_flow_terms_tuple_flf(self, bud, izone, ich):
